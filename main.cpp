...
vector<float> cutBlade(float _length , float _depth);
...
void bladesGenerator(string mode_, float additionFactor){
    ...
    for (int i=0; i < _x.size(); i++) {
        ...
        _blade->createBlade(_startPoint,cutBlade(_y[i], _depth[i]), mode_);
...
void setup()
{
    ...
    texturing("/Users/youssef_mac/Desktop/Blue_Sky.tga", "/Users/youssef_mac/Desktop/ground.tga");
...
vector<float> cutBlade(float _length , float _depth){
    vector<float> _list;
    float _x1,_x2,_y1,_y2,_newLength;
